...
args.save_pubtator = os.path.join('./result/' + args.task + '/' + args.task + '_results')
...
args.device = device
args.config_name = "/Users/kavithakamarthy/Downloads/SSGU-CD-all/dataset/cdr/data/pretrained/scibert_scivocab_cased"
...
#run the evaluation of test features
